...
def seed_demo_data(db: Session) -> None:
    ...
    db.add_all(
        [
            Service(id=make_id("srv"), business_id=business.id, name="Corte de cabello", description="Corte profesional y lavado.", duration_minutes=45, price=18.0, active=True),
            Service(id=make_id("srv"), business_id=business.id, name="Barba", description="Perfilado y acabado.", duration_minutes=30, price=12.0, active=True),
